"""
This module has been generated by the QGIS plugin builder plugin.

This module contains no plugin specific logic, basically all of this is
...
class QgisTim:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "QgisTim_{}.qm".format(locale)
        )
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("QgisTim", message)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = QgisTimDockWidget(self.iface)
