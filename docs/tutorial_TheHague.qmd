...
(@) In the *Layers* panel right click on the layer ![](figures/tutorial/figure_Leakylinedoublet_icon.png){width=4%} *timml Leaky Wall:sheet_pile* and start the editing mode by clicking the *Toggle Editing* button (![](figures/tutorial/button-Qgis-AttributeTable-StartEditingMode.png ){width=4%}).
...
(@) In layer *timml Leaky Wall:...* change the value for "resistance" into 5000 d (500x10).
...
(@) In the *Layers* panel select the new layer *timml Leaky Wall:sheet_pile_l1*.
