...
![QGIS-Tim panel](figures/tutorial/Panel-QGIS-Tim.png){width=70% #fig-Panel-QGIS-Tim}
...
\* **NB!** In de real world we always start counting with 1. However, TIM is programmed in Python and in Python couting starts with 0. 
...
(@) In your geopackage select the layer "timml Aquifer:Aquifer" and click your right mouse button.
(@) From the menu select *Attribute Tabel* and the table opens in a new window. <br> **NB** Alternatief is to press Shift + F6 or use the button *Open Attrribute Tabel* (![](figures/tutorial/button-Qgis-OpenAttributeTabel.png){width=4%}).
...
The Holoceen toplayer is not a distinguished layer but a resistance on top of layer 0.  
...
|---|---|---|---|---|---|---|---|
|1|0|1500|0.01|-17|-22|-5|-6|
|2|1|0.5|30|-22|-27|NULL|NULL|
|3|2|1.25|30|-27|-47|NULL|NULL|
|4|3|2|30|-47|-67|NULL|NULL|

(@) Go to the tab *Compute* and run the new model by clicking *Compute*.


damwand  (timml Leaky Line Doublet:damwand)
